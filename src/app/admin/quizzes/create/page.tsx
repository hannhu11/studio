...
export default function CreateQuizPage() {
  ...
  const handlePublishQuiz = () => {
    ...
    // For now, we'll add it to the mock data array to simulate persistence.
    const newQuiz: Quiz = {
      id: `quiz-${Date.now()}`,
      title: quizTitle,
    ...
    mockQuizzes.unshift(newQuiz); // Add to the beginning of the list
            ...
            <CardContent>
              ...
              {generatedQuiz && (
                <div className="space-y-6">
                  ...
                  <Button size="lg" className="w-full mt-6" onClick={handlePublishQuiz} disabled={isPublishing}>
